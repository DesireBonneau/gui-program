...
class HERGPredictorWindow(ToolWindowPrototype):
    def __init__(self, parent, show_screen_callback):
        # You can specify tool name and number of inputs for this tool
        super().__init__(parent, show_screen_callback, tool_name="hERG Predictor", num_inputs=7)
